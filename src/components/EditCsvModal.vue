...
const syncWithHubSpot = async () => {
  try {
    ...
    await fetch('https://flat-file-parser-backend.onrender.com/csv-data', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(payload),
    });
    const res = await fetch('https://flat-file-parser-backend.onrender.com/process-csv', { method: 'POST' });
